...
class PrincipalFrame(ctk.CTkFrame):
    ...
    def inicio(self):
        ...
        crear_label(
            frame_inicio, text="Inicio", font=("Roboto", 32, "bold"), text_color=COLOR_PRIMARIO,
        )
    ...
    def crear_publicacion(self):
        ...
        crear_label(
            frame_publicar, text="Crear publicación", font=("Roboto", 32, "bold"), text_color=COLOR_PRIMARIO,
        )
    ...
    def perfil(self):
        ...
        crear_label(
            frame_perfil, text="Mi perfil", font=("Roboto", 32, "bold"), text_color=COLOR_PRIMARIO,
        )
    ...
    def configuraciones(self):
        ...
        crear_label(
            frame_configuracion, text="Configuración", font=("Roboto", 32, "bold"), text_color=COLOR_PRIMARIO,
        )
